...
export const checkSalaryBtn = document.getElementById("checkSalaryBtn");
export const applyStatusLine = document.getElementById("applyStatusLine");
export const salaryResult = document.getElementById("salaryResult");
export const salaryResultBody = document.getElementById("salaryResultBody");
